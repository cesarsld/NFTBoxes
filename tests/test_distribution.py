...
def test_authorised(nftbox, minter, accounts):
    nftbox.createBoxMould(50, 50,  Wei('0.1 ether'), [1, 2, 3, 4], [], [], "This is a test box", "", "", "", "", {'from':minter})
...
def test_toomany_boxes_at_once(nftbox, minter, accounts):
    nftbox.createBoxMould(50, 5,  Wei('0.1 ether'), [1, 2, 3, 4], [], [], "This is a test box", "", "", "", "", {'from':minter})
...
def test_lock(nftbox, minter, accounts):
    nftbox.createBoxMould(50, 50,  Wei('0.1 ether'), [1, 2, 3, 4], [], [], "This is a test box", "", "", "", "", {'from':minter})
    nftbox.createBoxMould(25, 50, Wei('.20 ether'), [5, 6], [], [], "This is a second test box", "", "", "", "", {'from':minter})
    u1 = accounts[0]
    u2 = accounts[1]
...
def test_not_buyable_edition_many(nftbox, minter, accounts):
    nftbox.createBoxMould(5, 5, Wei('0.01 ether'), [1, 2, 3, 4], [], [], "This is a test box", "", "", "", "", {'from':minter})
...
def test_box_out_of_range(nftbox, joy, minter, accounts):
    ...
    nftbox.createBoxMould(1, 1, Wei('100 ether'), [1], [], [], "This is a test box", "", "", "", "", {'from':minter})
...
def test_many_of_one(nftbox, minter, accounts):
    nftbox.createBoxMould(50, 50, Wei('0.01 ether'), [1, 2, 3, 4], [], [], "This is a test box", "", "", "", "", {'from':minter})
    nftbox.createBoxMould(20, 50, Wei('0.1 ether'), [1, 2, 3, 4], [], [], "This is a test box", "", "", "", "", {'from':minter})
...
def test_many_at_once(nftbox, minter, accounts):
    nftbox.createBoxMould(30, 30, Wei('0.01 ether'), [1, 2, 3, 4], [], [], "This is a test box", "", "", "", "", {'from':minter})
    nftbox.createBoxMould(20, 20, Wei('0.1 ether'), [1, 2, 3, 4], [], [], "This is a test box", "", "", "", "", {'from':minter})
    nftbox.buyManyBoxes(2, 5, {'from':accounts[0], "value": Wei("0.1 ether") * 5})
    supply = nftbox.totalSupply()
    for i in range(10):
        nftbox.buyManyBoxes(1, 1, {'from':accounts[0], "value": Wei("0.01 ether")})
...
def test_shares(nftbox, joy, minter, accounts, me, me2, me3, big):
    joy.setCaller(nftbox, True, {'from':minter})
    nftbox.setVendingMachine(joy, {'from': minter})
    nftbox.createBoxMould(1, 1, Wei('100 ether'), [1], [accounts[1], accounts[2], accounts[3]], [240, 260, 250], "This is a test box", "", "", "", "", {'from':minter})
    joy.createJOYtoy("c0ffee", "someType", "over 9000", "toy", "fun", 100, True, 0, 0, {'from':minter})
