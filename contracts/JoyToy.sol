...
import "@openzeppelin/contracts/introspecttioin/ERC165.sol";
...
contract NFTBoxesNFT is ERC721, Ownable, HasSecondarySaleFees {
    ...
    function createNFTMould(string memory artworkHashIPFS, string memory artworkHashArweave, string memory artistName, 
    address signatureAddress, string memory signatureHash, string memory signatureMessage,  uint256 editionSize,
    string memory artTitle, string memory artworkType, string memory boxDetails, address payable royaltyAddress,
    uint256 royaltyBps) public onlyOwner {
